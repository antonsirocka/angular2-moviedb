System.register(['@angular/core', 'rxjs/Observable', '../services/movie-service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, Observable_1, movie_service_1;
    var MovieMockedService;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            MovieMockedService = (function (_super) {
            ...
            exports_1("MovieMockedService", MovieMockedService);
        }
    }
});
